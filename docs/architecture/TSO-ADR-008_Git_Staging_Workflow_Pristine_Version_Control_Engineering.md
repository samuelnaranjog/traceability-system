...
> [!info] 🏛️ TSO-ADR-008\_Git\_Staging\_Workflow\_Pristine\_Version\_Control\_Engineering
>
...
> | Type                | Route                                                                                                                                                                                                                                                                                               |
> | :------------------ | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
> | **📓 Requirements** | [TSO-REQ-023\_Git\_Worktree\_Set\_Up\_&\_Spawn\_Orchestrator](../requirements/TSO-REQ-023_Git_Worktree_Set_Up_&_Spawn_Orchestrator.md)<br />[TSO-REQ-024\_Workflow\_Worktree\_Closure\_&\_Collapse\_Orchestrator](../requirements/TSO-REQ-024_Workflow_Worktree_Closure_&_Collapse_Orchestrator.md) |
>
> ## <span hidden data-connections-begin></span> <span hidden data-connections-end></span>
>
...
> | ----------------- | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
> | **`feat`**        | Feature           | A new capability or functionality added to the codebase. This is the only type that signifies a move from *3-Active* to *4-Done*.     |
...
> >
> > In the traceability system this will be translated as transitioning the status of the *requirement* from 3-Active to 4-Done.
> >
...
> > A requirement requires an update or improvement in functionality to do so use `feat(<scope>): [ID] <subject>` but update the scope and subject of the update commit. *Is foundational that this follows the ready to deploy feature instructions*.
> >
> > *Example:*
> >
...
> | **`core`**                    | Main system features,  central engine state modifications, common shared behaviors | `feat(core): Implement new feature`                                            |
...
| --------------------------------- | ------------------------------------------------------------------------- |
| 2026-07-01                        | [TSO-ADR-008\_Analytical\_Breakdown](TSO-ADR-008_Analytical_Breakdown.md) |
